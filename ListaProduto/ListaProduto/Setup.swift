...
class Setup: NSObject {
    ...
    private class func setupCoreDataStack() {
        ...
        // Criação do modelo
        let modelURL:NSURL? = NSBundle.mainBundle().URLForResource("ListaProduto", withExtension: "momd")
        ...
        let sqlLitePath = docPath.URLByAppendingPathComponent("ListaProduto.sqlite")
